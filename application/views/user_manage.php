...
<div class="CSSTableGenerator">
	...
	<tbody>
		...
		<tr>
			...
			<td><a href="<?php echo base_url();?>user_con/edit_user/<?php echo $user->user_id;?>"><button class="btn btn-warning">Edit</button></a></td>
			<td><a onclick="return confirm('Do you want to delete User ID : <?php echo $user->user_id; ?> ?')" href="<?php echo base_url();?>user_con/delete_user/<?php echo $user->user_id;?>"><button class="btn btn-danger">Delete</button></a></td>
		</tr>
		<?php endforeach; ?>
	</tbody>
 ...
 <div>
<a href="<?php echo base_url();?>register_con/index"><button class="btn" type="button" style="background:#dff0d8">Add User</button> </a>
