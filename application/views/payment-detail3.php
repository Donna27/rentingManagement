...
<div >navigate<br />
  ...
  <li  ><a href="<?php echo base_url() ?>payment_con/pay_in_advance">ชำระเงินล่วงหน้า</a></li>
  <li class="active"><a href="<?php echo base_url() ?>payment_con/pay_history">ประวัติการชำระเงิน</a></li>
</ul></div>
