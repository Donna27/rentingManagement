...
<!--nav-->
	<div >House Management / House Add <br />
 	<hr style="border:0;border-bottom:2px dashed #ABF"/>
 	</div>
    
    <div class="head-name">Add New House</div>
    <br />
	<form name="addhouse" id="addhouse" action="<?php echo base_url();?>house_con/insert_house" method="POST">
		<table align="">
			<tr align="left">
				<td>House Name</td>
				<td><input id="housename" name="housename" type="text"/></td>
			</tr>
			<tr align="left">
				<td>House Address</td>
				<td><textarea id="houseaddress" name="houseaddress" rows="3" style="resize:none;" ></textarea></td>
			</tr>
			<tr align="left">
				<td>House Type</td>
			...
			<tr>
				...
				<td>
					...
					<input type="radio" name="type_id" checked value="<?php echo $type->type_id; ?>">
					<?php echo $type->type_name; ?>( <?php echo $type->rent_fee; ?> บาท) <br/>
					<?php endforeach; ?>
				</td>
			</tr>
