...
<body>
  ...
  <li class="active">History</li>
  	...
  	<hr style="border-bottom:thin; color:#CCC;margin-top:-22px"/><br />
 
   <div style="margin-left:87px;"><span>&nbsp;&nbsp;Click to see house history &nbsp;&nbsp;</span> 
 ...
 <div align="left" style="width:780; margin-left:87px">
			<?php foreach($houses as $house): ?>
					...
					<a href="<?php echo base_url();?>history_con/index/<?php echo $house->house_id;?>">
					<?php }else{ ?>
