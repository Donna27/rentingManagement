...
<style type="text/css">
	...
	background-image: url(<?php echo pathResource;?>img/wallpeper.jpg);
		}
	.content{
	height:920px;
	width:1160px;
	...
	box-shadow:5px 0px 7px 0px #C9C9C9;
	background: #999; /* for non-css3 browsers */

filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#1B79A3', endColorstr='#2597C7'); /* for IE */
	background: -webkit-gradient(linear, left top, left bottom, from(#1B79A3), to(#2597C7)); /* for firefox 3.6+ */
	background-image: url(<?php echo pathResource;?>img/wallhead.png);
...
<!--nav-->
	<div class="nav">navigate <br />
 	<hr style="border:0;border-bottom:1px dashed #AAA" />
 	</div>
    
    <div class="head-name">Select Customer</div>
    <br />
