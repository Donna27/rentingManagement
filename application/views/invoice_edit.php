...
<body>
  ...
  <li class="active">Edit Invoice</li>
    ...
    <a href="<?php echo base_url() ?>menu_con/invoice">เพิ่มใบแจ้งหนี้</a>
  	...
  	<li class="active"><a href="<?php echo base_url() ?>invoice_con/edit_invoice">แก้ไขใบแจ้งหนี้</a></li>
    ...
    <div style="font-size:22px; font-family:Arial, Helvetica, sans-serif;margin-left:20px"><p></p></div>
    

    <div ><div class="CSSTableGenerator" >
	<form method="POST" name="add_invoice" autocomplete="off" id="add_invoice" action="<?php echo base_url();?>invoice_con/update_only" >
				...
				<?php $i=1 ?>
				  <?php foreach($invoices as $invoice): ?>
					<tr>
						...
						<td><input name="water_bill<?php echo $i; ?>" id="water_bill<?php echo $i; ?>" onchange="calculate<?php echo $i; ?>()" type="text" size="5" maxlength="4" style="width:40px;" value="<?php echo $invoice->water_bill; ?>"></td>
						...
						<td><input name="elec_unit<?php echo $i; ?>" id="elec_unit<?php echo $i; ?>" onchange="calculate<?php echo $i; ?>()" type="text" size="5" maxlength="4" style="width:40px;" value="<?php echo $invoice->electric_unit; ?>"></td>
						<td><input name="elec_bill<?php echo $i; ?>" id="elec_bill<?php echo $i; ?>" readonly="true"  type="text" size="5" maxlength="4" style="width:40px;" value="<?php echo $invoice->electric_bill; ?>"></td>
						<td><input name="rent_fee<?php echo $i; ?>" id="rent_fee<?php echo $i; ?>" type="text" size="5" maxlength="5" style="width:40px;" value="<?php echo $invoice->rent_fee; ?>"></td>
						<td><input name="total<?php echo $i; ?>" id="total<?php echo $i; ?>" readonly="true" type="text" size="5" maxlength="6" style="width:50px;" value="<?php echo $invoice->total_amount; ?>"></td>
						<td><a target="_blank" href="<?php echo base_url();?>invoice_con/view_invoice_inside/<?php echo $invoice->invoice_id; ?>"><button class="btn btn-success" type="button">View</button></a></td>
					</tr>
					<?php $i++ ?>
					<?php endforeach; ?>
				 </tbody>  
				...
				<br />
				<button class="btn btn-primary" type="submit">Update all invoice</button>
				</div>
				</form>
